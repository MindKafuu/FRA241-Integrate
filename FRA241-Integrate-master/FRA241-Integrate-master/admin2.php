...
<html lang="en">
  ...
  <body>
    ...
    <div style="margin-top: 20px; margin-left:33.3%">
        ...
        <a href="#" id="showAdd"  style=" margin-left:1000px ; margin-top: -50px " class = "button4"  >
        <span class = "content"><b>+Add User</b></span></a>
<!-- ปุ่มsave-->
        <save><button id ="hidesave" name="save_account" style=" margin-left:1050px ; margin-top:60px " class = "buttonsave">
                <span class = "content"><b>save</b></span>
        </button>
<!-- link data base -->
        <center>
        <div  style='margin-top:-85px; margin-left:100px;border-radius: 6px; background-color:white; height:205px ; width: 550px'>

                <b style =" margin-left:70px;margin-top:40px; font-family: 'Work Sans', sans-serif; font-size: 16px ">Name</b>
                <input style ="width:350px; height:23px; margin-top:40px; margin-left:55px" name="name" type="text" placeholder="Name"><!-- link data base -->
                <br>
        ...
        <a href="#" id="showRemove"  style=" margin-left:1000px ; margin-top: -50px " class = "button4"  >
        <span class = "content"><b>-Remove</b></span></a>
<!-- ปุ่มsave-->
        <remove><button id ="hideremove" name="remove_account" style=" margin-left:1050px ; margin-top:-30px " class = "buttonsave">
...
<!-- link data base -->
        ...
        <cancel><button id ="hidecancel" style=" margin-left:1050px ; margin-top:-170px " class = "buttonsave">
                <span class = "content"><b>cancel</b></span>
                </button>
        </cancel><br><br><br><br>
        <cancel1><button id ="hidecancel" style=" margin-left:1050px ; margin-top:-30px " class = "buttonsave">
                <span class = "content"><b>cancel</b></span>
                </button>
        </cancel1>
