  ...
  <body>
    ...
    <div style="margin-top: 20px; margin-left:33.3%">
        ...
        <div style="margin-top:25px;">
            ...
            <div type ="button"><a href="admin5-fibo.php" class="btn2" style="background-color:#79a2ff"><b>FIBO Subjects</b></a></div><br><br>
            <div style="margin-top:-15px"><a href="admin5-fund.php" class="btn2"><b>Fundamental Subjects</b></div></a><br><br>
