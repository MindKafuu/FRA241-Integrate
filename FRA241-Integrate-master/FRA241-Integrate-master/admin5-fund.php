  ...
  <body>
    ...
    <div style="margin-top: 20px; margin-left:33.3%">
        ...
        <div style="margin-top:25px;">
            ...
            <div type ="button"><a href="admin5-fibo.php" class="btn2" ><b>FIBO Subjects</b></a></div><br><br>
            <div style="margin-top:-15px"><a href="admin5-fund.php" class="btn2" style="background-color:#79a2ff"><b>Fundamental Subjects</b></div></a><br><br>
            <div style="margin-top:-15px"><a href="admin5-classroom.php" class="btn2"><b>Classroom</b></div></a><br><br>
        </div>
        ...
        <?php
                 ...
                 $x=1;
                    while($row = mysqli_fetch_array($smyData2)){
                        ...
                        <a href = 'admin3-linkfund.php'><button class='editbutton'><i class='material-icons'>mode_edit</i></button></a></b></p><br>";
                        $x++;
                        if($save != "") {
                            echo "<p>".$save."</p><br>";
                        }
