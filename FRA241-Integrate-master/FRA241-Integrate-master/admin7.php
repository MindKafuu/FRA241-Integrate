...
<table>
    ...
    <tr>
        <td style="background-color: #00ff55;color:black">
            Wednesday
        </td>
        <?php
            createTable("1", "A", "2");
    ...
    <tr>
        <td style="background-color:#1aa3ff;color:black">
            Friday
        </td>
        <?php
            createTable("1", "A", "4");
    ...
    <tr>
        <td style="background-color: #E066FF;color:black">
            Saturday
        </td>
        <?php
            createTable("1", "A", "5");
...
<?php
    function createTable($year, $sec, $day) {
        ...
        while($row = mysqli_fetch_array($smyData)) {
            ...
            if($row['subject_level'] == $year ) {
                if($row['subject_sec'] == $sec || $row['subject_sec'] == "AB") {
                    if($row['Day'] == $day){
                        if($time == 99) {
                            echo "<td style='background-color:#f2f2f2;' colspan='10'></td>";
                        }
                        else if($time >= 0) {
                            $count = $count + 1;
                            if($count == 1) {
                                if($time == 0) {
                                    echo "<td style='background-color: #00FA9A' colspan='$hour' ><b>". $row['subject_code'] ."</td></b>";
                                    $check1 = $check1 + $hour;
                                }
                                else if($time > 0) {
                                    echo "<td style='background-color:#f2f2f2;' colspan='$time'></td>";
                                    echo "<td style='background-color: #00FA9A' colspan='$hour'><b>" . $row['subject_code'] . "</td></b>";
                                ...
                                if($time == 1) {
                                    if(abs($check1 - 1) == 0) {
                                        ...
                                        echo "<td style='background-color:#f2f2f2;' colspan='$sum'></td>";
                                        echo "<td style='background-color: #00FA9A' colspan='$hour'><b>" . $row['subject_code'] . "</td></b>";
        ...
        $total = 10 - $total;
        if($total != 0) {
            echo "<td style='background-color: #f2f2f2;' colspan='10-$total'></td>";
        }
    }
?>