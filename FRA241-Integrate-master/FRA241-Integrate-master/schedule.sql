...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 29, 2017 at 11:03 PM
...
CREATE TABLE `table_fundamental_subjects` (
  `No` int(3) NOT NULL,
  `subject_level` varchar(100) DEFAULT NULL,
  `subject_code` varchar(100) DEFAULT NULL,
  `subject_name` varchar(100) DEFAULT NULL,
  `subject_hour_per_week` varchar(100) DEFAULT NULL,
  `subject_sec` varchar(100) DEFAULT NULL,
...
(1, '1', 'FRA141', 'Computer Programming ', '4', '2/2', 'AA', 'FB306'),
...
(25, '1', 'FRA141', 'Computer Programming', '4', '2/2', 'AB', 'FB306'),
(26, '2', 'FRA241', 'Software development', '3', '1/2', 'AB', 'FB403-4'),
(27, '3', 'knight', '56453', '6', '1/5', 'AB', 'FB403-4'),
(28, '1', 'FRA161', 'Robotic exploration', '3', '1/2', 'AA', 'FB401');
...
(1, '1', 'FRA141', 'Computer Programming', '4', NULL),
(2, '1', 'FRA141', 'Computer Programming', '4', NULL),
(3, '1', 'FRA161', 'Robotic exploration', '3', NULL),
(4, '1', 'FRA161', 'Robotic exploration', '3', NULL),
(5, '2', 'FRA221', 'Digital Electronics', '3', NULL),
(6, '2', 'FRA222', 'Industrial Sensor and Actuators', '3', NULL),
(7, '2', 'FRA241', 'Software development', '3', NULL),
(8, '3', 'knight', '56453', '6', NULL);
...
(70, ' Assoc. Prof. Dr.Siam Charoenseang', '0', '0'),
(71, ' Assoc. Prof. Dr.Siam Charoenseang', '5', '9'),
(72, ' 888', '5', '7'),
(73, ' 888', '5', '8'),
(74, ' 888', '5', '9');
...
(1, 'Mr.Bawornsak Sakulkueakulsuk', 'FRA141'),
(2, 'Dr.Warasinee Chaisangmongkon', 'FRA141'),
(3, 'Dr.Boontariga Kasemsontitum', 'FRA161'),
(4, 'Dr.Pitiwut Teerakittikul', 'FRA161'),
(5, 'Dr.Pitiwut Teerakittikul', 'FRA221'),
(6, 'Dr.Supachai Vongbunyong', 'FRA222'),
(7, 'Mr.Bawornsak Sakulkueakulsuk', 'FRA241'),
(8, '888', 'knight');
...
--
ALTER TABLE `table_subject_description_input`
  MODIFY `No` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
COMMIT;
