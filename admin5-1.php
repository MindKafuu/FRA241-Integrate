  ...
  <body>
    ...
    <div style="margin-top: 20px; margin-left:33.3%">
        ...
        <div style="margin-top:25px;">
            ...
            <a href="admin5-1.php" class="btn2"style="background-color:#79a2ff"><b>FIBO Subjests</b></a><br><br>
            <a href="admin5-2.php" class="btn2"><b>Fundamental Subjects</b></a><br><br>
        ...
        <?php
                 $allsubject = "SELECT DISTINCT subject_code,subject_name FROM table_subject_description_input";
